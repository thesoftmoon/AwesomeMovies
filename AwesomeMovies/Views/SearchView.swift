            ...
            .toolbar {
                ToolbarItem(placement: .topBarTrailing) {
                    Button {
                        ...
                        Task {
                            await searchViewModel.getSearchTitles(by: searchByMovie ? "movie" : "tv", for: searchString)
                        }

                    } label: {
                        Image(
                            systemName: searchByMovie ? Constants.movieIconString : Constants.tvIconString)
                    }
                }
            }.searchable(
                text: $searchString,
                prompt: searchByMovie ? Constants.movieSearchPlaceholderString : Constants.tvSearchPlaceholderString
            )
